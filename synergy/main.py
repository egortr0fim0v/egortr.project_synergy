...
class Db:
    ...
    def default_data(self):
        usr = [
            (1, 'Демидов Егор Андреевич','+79678673453','demidovE@mail.ru', 99000),
            (2, 'Сироткина Елена Дмитриевна','+79123456780','lenasir@mail.ru', 150540),
            (3, 'Малышева Наталья Павловна','+79574638452','natamalishka@mail.ru', 82000),
            (4, 'Иванов Владимир Васильевич','+79890376893','vovkaivan@mail.ru', 75000),
            (5, 'Мендеров Иван Павлович','+79234987502','vankamender@mail.ru', 90000)
        ]
